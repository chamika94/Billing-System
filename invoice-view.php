...
?>
        ...
        <div class="row">
           ...
           <a type="button" onClick="" data-dismiss=""class="btn  btn-sm btn-success" href="pre-invoice.php" id=""> Back to List</a>
                     <a type="button" onClick="" data-dismiss=""class="btn btn-sm btn-warning" href="invoice.php" id=""> New</a>

                     <a class="btn btn-danger btn-sm login modal-form" data-target="" data-toggle="" onClick="" id="view" href="download-invoice.php?cid=<?php echo $cid; ?>&vid=<?php echo $vid; ?>&date=<?php echo $date; ?>&token=<?php echo $token; ?>&type=<?php echo $type; ?>&status=<?php echo $status; ?>&deposite=<?php echo $deposite; ?>"> Download</a>
                 </div>

     ...
     <!--   <div class="row">
                           ...
                           <!--     <div class="col-lg-12">
                                        <div class="form-group">
                                              ...
                                              <div class="col-md-4" style="margin-left:970px; margin-top:-38px;padding:10px">
                                               ...
                                               <a class="btn btn-success btn-sm login modal-form" data-target="" data-toggle="" onClick="" href="pre-checklist.php" id="" >Go To List</a>
                                               </div>
                                               <br>
                                        </div>
                                 </div>     -->                        
		...
		<div class="row">
			<div class="col-sm-12">
					  ...
					  <a style=""class="btn btn-info btn-sm vehicle login modal-form" onClick="" href="summaryreport.php">Back To New</a>
                    <a class="btn btn-success btn-sm login modal-form" data-target="" data-toggle="" onClick="" href="pre-summaryreport.php" id="" >Go To List</a>
                       </div>

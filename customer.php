	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Customer</div>
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            ...
                                                            <a class="btn btn-info btn-sm" href="customer-list.php">List</a>                                                
                                            </div>                  
                                </td>
                            </tr>
                            </table>
    ...
    <div class="modal-dialog">
      ...
      <div id="signup-content" class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-lock"></i>Customer Registration</h4>
        </div>
        ...
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" method="POST" action="add-customer-backend.php" enctype="multipart/form-data">
                        ...
                        <!-- Textarea -->
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="description" >Residental Address</label>
                        <div class="col-md-6">                     
                            <textarea class="form-control" rows="5" id="address" name="address" placeholder='Residental Address'></textarea>
                        </div>
                        </div>
                        ...
                        <!-- Text input-->
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Home Number</label>  
                        <div class="col-md-6">
                        <input id="home" name="home" type="text" placeholder="Home Number" class="form-control input-md" required="">
                        ...
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Office Number</label>  
                        <div class="col-md-6">
                        <input id="office" name="office" type="text" placeholder="Office Number" class="form-control input-md" required="">
                        ...
                        <div class="form-group" >
                                ...
                                <div style="color:red" class="col-md-6" id="message">

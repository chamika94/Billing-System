	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Description List</div>
...
// hear we search term exist then process the below lines of code
    ...
    $sql_query ="SELECT * FROM description order by added_date DESC";
             ...
             <!-- /.row -->
                ...
                ?>
                   ...
                   <tr class="delete_mem<?php echo $name_val["id"]; ?>">
                       ...
                       <td ><?php echo $name_val["description"]; ?></td>

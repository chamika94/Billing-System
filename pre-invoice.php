		...
		<div class="row">
			<div class="col-sm-12">
			  	<div class="col-sm-12">   
				    <div class="col-sm-12">  
				      <div class="modal-footer">
                          <a type="button" onClick="" data-dismiss=""class="btn btn-info" href="invoice-home.php" id=""> Back</a>
...
<!-- script to fillter data list order by day month year/vin/rego-->	

...
<head>
	...
	<title>Previous CheckList</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Previous CheckList</div>
									...
									<div class="col-md-12">
									   <div class="col-md-12">
										...
										<div class="list-group check1">
												<h3></h3>
												<div class="list-group-item checkbox">
												<input class="form-control me-2"autocomplete="off" type="text" placeholder="Search" aria-label="Search" id="filter_vin"required="">
													<label><input type="checkbox" class="common_selector vin" value="vin"  >Vin</label>
												</div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="list-group check1">
												<h3></h3>
												<div class="list-group-item checkbox">
												<input class="form-control me-2"autocomplete="off" type="text" placeholder="Search" aria-label="Search" id="filter_rego"required="">
													<label><input type="checkbox" class="common_selector rego" value="rego"  >Rego</label>
												</div>
											</div>
										</div>
										...
										<div class="list-group check1">
												<h3></h3>
												<div class="list-group-item checkbox">
												<input class="form-control me-2"autocomplete="off" type="text" placeholder="Search" aria-label="Search" id="filter_mobile"required="">
													<label><input type="checkbox" class="common_selector mobile" value="mobile"  >Mobile</label>
												</div>
											</div>
										</div>
										...
										<div class="list-group check1">
												<h3></h3>
												<div class="list-group-item checkbox">
												<input class="form-control me-2" type="date" id="filter_input">
													<label><input type="checkbox" class="common_selector day" value="" >day</label>
													<label><input type="checkbox" class="common_selector month" value="" >month</label>
													<label><input type="checkbox" class="common_selector year" value="" >year</label>
												</div>
...
-->
               ...
               <!-- ====================================================== -->                 
                  <!--        <div class="row">    
                                ...
                                <div class="col-md-2"> 
                                    <div class="list-group-item checkbox">
                                        <label><input type="checkbox" class="common_selector year" value="year"  >Year</label>
                                    </div>
                                </div>
                                <div class="col-md-2"> 
                                    <div class="list-group-item checkbox">
                                        <label><input type="checkbox" class="common_selector month" value="month"  >Month</label>
                                    </div>
                                </div>
                                <div class="col-md-2"> 
                                    <div class="list-group-item checkbox">
                                        <label><input type="checkbox" class="common_selector day" value="day"  >Day</label>
                                    </div>
                                </div>                                        
		...
		<div class="row">
			<div class="col-sm-12">
			  	<div class="col-sm-12">   
				    <div class="col-sm-12">  
				      <div class="modal-footer">
                          <a type="button" onClick="" data-dismiss=""class="btn btn-info" href="checklist-home.php" id=""> Back</a>
...
<!-- script to fillter data list order by day month year and name vin mobile-->	
...
function filter_data(){
    ...
    $.ajax({
        url:"pre-checklist-backend.php",
        method:"POST",
        data:{filter_input:filter_input,year:year,month:month,day:day},

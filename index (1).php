...
<head>
	...
	<title>Vox Auto - Dashboard</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Home</div>
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-info btn-sm login modal-form" data-target="#login-form" data-toggle="" href="customer.php">Go</a>
                        ...
                        <div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-success btn-sm login modal-form" data-target="#login-form" data-toggle="" href="vehicle.php">Go</a>
						...
						<div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-danger btn-sm login modal-form" data-target="#login-form" data-toggle="" href="invoice-home.php">Go</a>
				   ...
				   <div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-warning btn-sm login modal-form" data-target="#login-form" data-toggle="" href="checklist-home.php">Go</a>
						...
						<div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
											<a class="btn btn-info btn-sm login modal-form" data-target="#login-form" data-toggle="" href="summaryreport-home.php">Go</a>
						...
						<div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
											<a class="btn btn-success btn-sm login modal-form" data-target="#login-form" data-toggle="" href="pre-invoice.php">Go</a>
                ...
                <div class="col-md-12"> 
				   ...
				   <div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            <div class="blog-news-title">
                                                <h3>Previous CheckList</h3>
                                            </div>
                                            <div class="blog-news-details">
											<a class="btn btn-danger btn-sm login modal-form" data-target="#login-form" data-toggle="" href="pre-checklist.php">Go</a>
						...
						<div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
											<a class="btn btn-warning btn-sm login modal-form" data-target="#login-form" data-toggle="" href="pre-summaryreport.php">Go</a>
						...
						<div class="col-md-4">                                       
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
											<a class="btn btn-info btn-sm login modal-form" data-target="#login-form" data-toggle="" href="admin.php">Go</a>
...
<script>
    $(document).ready(function() {
            ...
            var office = $('#office').val();
                    ...
                    $.ajax({
                    url: "add-customer-backend.php",
                    type: "post",
                    data: {name : name, address : address, email : email, mobile : mobile, home : home, office : office},

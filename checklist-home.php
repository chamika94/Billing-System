                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-success btn-sm login modal-form" data-target="#login-form" data-toggle="" href="checklist.php">Add New</a>
                                                           
                                                            <a class="btn btn-info btn-sm" href="pre-checklist.php">List</a>                                                
                                            </div>                  
                                </td>
                            </tr>
                            </table>

	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Customer List</div>
...
// hear we search term exist then process the below lines of code
    ...
    $sql_query ="SELECT * FROM customer order by created_date DESC";
...
<div class="panel panel-container"> 
             ...
             <!-- /.row -->
					  <div class="row">
                              ...
                              <div id="name-list" style="cursor:pointer;">
				                <div class="table-responsive">
                                   <table class="table table-striped table-bordered">
									...
									<tr class="delete_mem<?php echo $name_val["ccid"]; ?>">
										
										<td ><?php echo $name_val["name"]; ?></td>
										<td ><?php echo $name_val["created_date"]; ?></td>
										<td width="80">
										<a class="btn btn-xs btn-danger" id="<?php echo $name_val["ccid"]; ?>">Delete</a>
										</td>
						...
						<a type="button" onClick="" data-dismiss=""class="btn btn-success" href="customer.php" id=""> Back</a>

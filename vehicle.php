	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">Vehicle</div>
                            ...
                            <tr>
                                <td colspan="3"> 
                                            ...
                                            <div class="blog-news-details">
                                                            <a class="btn btn-success btn-sm login modal-form" data-target="#login-form" data-toggle="modal" href="#">Add New</a>
                                                           
                                                            <a class="btn btn-info btn-sm" href="vehicle-list.php">List</a>                                                
                                            </div>                  
                                </td>
                            </tr>
                            </table>
    ...
    <div class="modal-dialog">
      ...
      <div id="signup-content" class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-lock"></i>Vehicle Registration</h4>
        </div>
        <div class="modal-body">
        <div class="row">
                <div class="col-lg-12">
                    
                    <form class="form-horizontal" method="POST" action="add-customer-backend.php" enctype="multipart/form-data">
                        <fieldset>            
                    

                        <!-- Text input-->
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Vin</label>  
                        <div class="col-md-6">
                        <input id="vin" name="name" type="text" placeholder="Vin" class="form-control input-md" required="">
                            
                        </div>
                        </div>

                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Rego</label>  
                        <div class="col-md-6">
                        <input id="rego" name="email" type="text" placeholder="Rego" class="form-control input-md" required="">
                        ...
                        <!-- File Button --> 
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Make</label>  
                        <div class="col-md-6">
                        <input id="make" name="mobile" type="text" placeholder="Make" class="form-control input-md" required="">
                            
                        </div>
                        </div>                        
                        <!-- Text input-->
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Modal</label>  
                        <div class="col-md-6">
                        <input id="modal" name="home" type="text" placeholder="Modal" class="form-control input-md" required="">
                        ...
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Engine</label>  
                        <div class="col-md-6">
                        <input id="eng" name="office" type="text" placeholder="Engine" class="form-control input-md" required="">
                            
                        </div>
                        </div>

                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Gear</label>  
                        <div class="col-md-6">
                        <input id="gear" name="office" type="text" placeholder="Gear" class="form-control input-md" required="">
                            
                        </div>
                        </div>
              
                        <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Paint</label>  
                        <div class="col-md-6">
                        <input id="paint" name="office" type="text" placeholder="Paint" class="form-control input-md" required="">
       ...
       <a type="button" onClick="" data-dismiss=""class="btn btn-success" id="butsave">Save changes</a>
...
<!--script for to be added customers-->  
<script>
    $(document).ready(function() {
            ...
            var paint = $('#paint').val();
                    ...
                    $.ajax({
                    url: "add-vehicle-backend.php",
                    type: "post",
                    data: {vin : vin, rego : rego, make : make, modal : modal, eng : eng, gear : gear, paint : paint},

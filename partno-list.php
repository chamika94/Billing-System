	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				...
				<div class="profile-usertitle-info">PartNo List</div>
...
// hear we search term exist then process the below lines of code
    ...
    $sql_query ="SELECT * FROM partno order by added_date DESC";
...
<div class="panel panel-container"> 
             <!-- /.row -->
                ...
                ?>
                   ...
                   <tr class="delete_mem<?php echo $name_val["id"]; ?>">
                      
                       <td ><?php echo $name_val["partNo"]; ?></td>
                       <td ><?php echo $name_val["added_date"]; ?></td>
                       <td width="80">
                       <a class="btn btn-xs btn-danger" id="<?php echo $name_val["id"]; ?>">Delete</a>
                      </td>
       ...
       <a type="button" onClick="" data-dismiss=""class="btn  btn-success" href="admin.php" id=""> Back</a>
